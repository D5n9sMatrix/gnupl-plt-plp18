...
system("mkdir gnuplay")
do for [ii=1:360] {
    set output sprintf('gnuplay/hrir_frame%03.0f.png',ii)
    ...
    plot "/home/denis/Workspace/gnupl-plt/gnu/matrix/bin/data/data9.txt" u ($1*1000):2*ii w l ls 1
    ...
    plot "/home/denis/Workspace/gnupl-plt/gnu/matrix/bin/data/data9.txt" u ($1*1000):2*ii+1 w l ls 1
    unset arrow
    unset label
    unset multiplot
}
